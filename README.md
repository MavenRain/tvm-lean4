...
This is the scaffold.  Subsequent commits cover serialization,
hashing, the instruction set, the small-step relation, the
inter-shard delivery model, and a contract specification language
inspired by Mi-Cho-Coq's Hoare-triple encoding.
